...
using Desi_Jokes.Services.SettingsServices;
...
using Desi_Jokes.Views;
using Desi_Jokes.ViewModels;
using Windows.UI.Core;

namespace Desi_Jokes
{
    ...
    sealed partial class App : Template10.Common.BootStrapper
    {
        public App()
        {
            ...
            CacheMaxDuration = TimeSpan.FromSeconds(2);
        ...
        private async Task<bool> registerBackgroundTaskForPushNotification()
        {
            ...
            if (backgroundStatus != BackgroundAccessStatus.Denied && backgroundStatus != BackgroundAccessStatus.Unspecified)
            {
                ...
                builder.TaskEntryPoint = "DesiJokes_BackgroundTasks.NotificationBackgroundTask";
